...
<body>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="index.html">
                    <?=\yii\helpers\Html::img('@web/images/logo.png')?></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
					...
					<dd>
						...
						<div class="uclist mt10">
							<ul class="list1 fl">
								<li><a href="">用户信息></a></li>
								<li><a href="">我的订单></a></li>
								<li><a href="shop/address.html">收货地址></a></li>
								<li><a href="">我的收藏></a></li>
							</ul>
	...
	<div class="guide w1210 bc mt15">
			...
			<div class="guide_wrap">
				...
				<div class="hot none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="web/images/hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="web/images/hot2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="web/images/hot3.jpg" alt="" /></a></dt>
				...
				<div class="recommend none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="web/images/recommend1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="web/images/recommend2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="web/images/recommend3.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="sidebar_wrap">
				<dl class="first">
					<dt class="fl"><a href=""><img src="web/images/viewsonic.jpg" alt="" /></a></dt>
				...
				<dl>
					<dt class="fr"><a href=""><img src="web/images/samsung.jpg" alt="" /></a></dt>
	...
	<div class="floor1 floor w1210 bc mt10">
		...
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					...
					<p><a href=""><img src="web/images/notebook.jpg" alt="" /></a></p>
				</div>
				...
				<div class="goodslist_wrap">
					<div>
						<ul>
							<li>
								<dl>
									<dt><a href=""><img src="web/images/hpG4.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="web/images/thinkpad e420.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="web/images/acer4739.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="web/images/samsung6800.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="web/images/lh531.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="web/images/qinghuax2.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="brand">
				...
				<div class="sidebar_wrap">
					<ul>
						<li><a href=""><img src="web/images/dell.gif" alt="" /></a></li>
						<li><a href=""><img src="web/images/acer.gif" alt="" /></a></li>
						<li><a href=""><img src="web/images/fujitsu.jpg" alt="" /></a></li>
						<li><a href=""><img src="web/images/hp.jpg" alt="" /></a></li>
						<li><a href=""><img src="web/images/lenove.jpg" alt="" /></a></li>
						<li><a href=""><img src="web/images/samsung.gif" alt="" /></a></li>
						<li><a href=""><img src="web/images/dlink.gif" alt="" /></a></li>
						<li><a href=""><img src="web/images/seagate.jpg" alt="" /></a></li>
						<li><a href=""><img src="web/images/intel.jpg" alt="" /></a></li>
					</ul>
				</div>
			</div>
			<!-- 品牌旗舰店 end -->
			...
			<!-- 广告 start -->
			<div class="ads mt10">
				<a href=""><img src="web/images/canon.jpg" alt="" /></a>
			</div>
			<!-- 广告 end -->
		</div>
		<!-- 右侧 end -->
