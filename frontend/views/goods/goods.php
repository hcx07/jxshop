...
?>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="/shop/index.html">首页</a> > <a href=""><?=$cate->name?></a> > <a href=""><?=$list->name?></a> > <?=$model->name?></h2>
		</div>
		<!-- 面包屑导航 end -->
				...
				<div class="preview fl">
					<div class="midpic">
						...
						<a href="/images/preview_l1.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                            <?=\yii\helpers\Html::img('http://admin.jx.com/'.$model->logo,['width'=>350,'height'=>350])?>
