...
<body>
	...
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="/goods/index.html"><img src="/images/logo.png" alt="京西商城"></a></h2>
			<div class="flow fr">
				<ul>
...
<!--            --><?php //var_dump($models);exit;?>
            <?php foreach($models as $model):?>
                ...
                <tr data-goods_id="<?=$model['id']?>">
                    <td class="col1"><a href=""><?=\yii\helpers\Html::img('http://admin.jx.com/'.$model['logo'])?></a>  <strong><a href=""><?=$model['name']?></a></strong></td>
			...
			<tfoot>
				<tr>
					<td colspan="6">购物金额总计： <strong>￥ <span id="total"><?php
                                $total=0;
                                foreach ($models as $model){
                                    $total+=$model['amount']*$model['shop_price'];

                                }
                                echo $total;?></span></strong></td>
				</tr>
			</tfoot>
		</table>
		<div class="cart_btn w990 bc mt10">
			<a href="" class="continue">继续购物</a>
			<a href="/goods/order.html" class="checkout">结 算</a>
		</div>
	</div>
	<!-- 主体部分 end -->
